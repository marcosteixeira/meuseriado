...
ActiveRecord::Schema.define(version: 20130920015543497) do
  ...
  add_index "commontator_threads", ["commontable_type", "commontable_id"], name: "index_commontator_threads_on_commontable_type_and_commontable_id", unique: true, using: :btree
