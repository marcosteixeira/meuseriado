...
class SeriesController < ApplicationController
          ...
          for s in series
            ...
            if s
              ...
              if s.poster
                ...
                serie_pesquisa.poster = "../assets/series/imagem_padrao.jpg"  
              end
  ...
  def copia_serie_api(serie)
    ...
    if serie.poster 
      ...
      nova_serie.poster = "../assets/series/imagem_padrao.jpg"
    end
    ...
    serie_tvdb.episodes.each do |episodio_tvdb|
      if episodio_tvdb.episode_name
        ...
        if episodio_tvdb.filename
          ...
          episodio.banner = "../assets/series/imagem_padrao.jpg"
        end
